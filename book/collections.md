...
и удалять элементы с обоеих сторон. Для начала вам нужно импортировать
...
Мы можем отрезать элементы с обоеих сторон очереди:
...
**именнованые кортежи не создают словари для каждого экземпляра**, они легковесны и
...
И последнее, вы можете сконвертировать именнованый кортеж в словарь. Вот так:
